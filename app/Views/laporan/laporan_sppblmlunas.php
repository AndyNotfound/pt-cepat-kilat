        ...
        <div class="row">
            <div class="col-lg-12 mt-5">
                <div class="row align-items-center">
                    <div class="col-6">
                        <img src="/img/logo-sekolah.jpeg" alt="img-laporan" class="img-laporan">
                    </div>
                ...
                <h3 class="text-center my-4">LAPORAN DATA SPP (BELUM LUNAS)</h3>
                <table border="1" cellpadding="10" cellspacing="0" width="100%">
                    <thead>
                        <tr>
                            <th scope="col" class="text-center" width="80">No</th>
                            <th scope="col" width="600">Nama Petugas</th>
                            <th scope="col">NISN</th>
                            <th scope="col" width="300">Nama Siswa</th>
                            <th scope="col">Bulan</th>
                            <th scope="col">Tahun</th>
                            <th scope="col" width="400">Tanggal Bayar</th>
                    ...
                    <tbody>
                        <?php
                        $siswa = $laporan->db->table('pembayaran')
